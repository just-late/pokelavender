...
tileset_maps = {
'johto_traditional': 'BellchimeTrail CherrygroveBay GlittervineTown DragonsDenB1F EcruteakCity MagnetTunnelEast MahoganyTown GemrootTown Route26 Route27 Route28 Route29 Route30 Route31 Route32 Route32Coast Route35 Route36 Route37 Route42 Route44 SilverCaveOutside VioletCity VioletOutskirts'.split(),
