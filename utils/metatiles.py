...
class Attributes(object):
	...
	map_palettes = {
		...
		'maps/DarkCaveMoonflowerEntrance.ablk': lambda: load_palette('gfx/tilesets/dark_cave.pal'),
		...
		'maps/MoonflowerCity.ablk': lambda: load_palette('gfx/tilesets/violet_ecruteak.pal')[8:16],
	...
	tileset_palettes = {
		...
		'marigold': lambda: Attributes.day_palette(),
