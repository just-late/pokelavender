...
TurtwigFootprint:: INCBIN "gfx/footprints/turtwig.1bpp.lz"
GrotleFootprint:: INCBIN "gfx/footprints/grotle.1bpp.lz"
TorterraFootprint:: INCBIN "gfx/footprints/torterra.1bpp.lz"
