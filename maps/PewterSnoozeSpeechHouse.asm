PewterSnoozeSpeechHouse_MapScriptHeader:
	...
	def_object_events
	object_event  5,  3, SPRITE_GRAMPS, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_BLUE, PERSONTYPE_COMMAND, jumptextfaceplayer, PewterSnoozeSpeechHouseGrampsText, -1
