KurtsHouse_MapScriptHeader:
	...
	def_object_events
	object_event  3,  2, SPRITE_KURT, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, Kurt1, EVENT_KURTS_HOUSE_KURT_1
	...
	object_event 14,  3, SPRITE_KURT, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, Kurt2, EVENT_KURTS_HOUSE_KURT_2
