Route39RuggedRoadGate_MapScriptHeader:
	...
	def_object_events
	object_event  0,  4, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_RED, PERSONTYPE_COMMAND, jumptextfaceplayer, Route39RuggedRoadGateOfficerText, -1
