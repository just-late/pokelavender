GraniteVillage_MapScriptHeader:
    ...
    def_warp_events
	warp_event 21, 17, GRANITE_INN_1F, 1
	warp_event 12,  7, GRANITE_VILLAGE_TRAIN_TRACK, 1
...
.AfterGruntBattle:
    ...
    applymovement GRANITE_VILLAGE_GRUNT_1, GraniteVillageGruntLeaves_Movement
