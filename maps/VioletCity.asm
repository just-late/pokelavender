...
;	warp_event 16, 18, ROUTE_36_VIOLET_GATE, 4
	...
	bg_event 23, 17, BGEVENT_ITEM + POKE_BALL, EVENT_VIOLET_CITY_HIDDEN_POKE_BALL
	bg_event 12, 11, BGEVENT_ITEM + RARE_CANDY, EVENT_VIOLET_CITY_RARE_CANDY
	bg_event 15, 11, BGEVENT_ITEM + PP_UP, EVENT_VIOLET_CITY_PP_UP
