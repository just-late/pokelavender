Route5UndergroundEntrance_MapScriptHeader:
	...
	def_object_events
	object_event  2,  3, SPRITE_TEACHER, SPRITEMOVEDATA_SPINRANDOM_SLOW, 1, 1, -1, -1, 0, PERSONTYPE_COMMAND, jumptextfaceplayer, Route5UndergroundPathEntranceTeacherText, -1
