DarkCaveBlackthornEntrance_MapScriptHeader:
	...
	warp_event  3, 25, DARK_CAVE_MOONFLOWER_ENTRANCE, 2
	...
	def_object_events
	object_event  7,  3, SPRITE_PHARMACIST, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_BLUE, PERSONTYPE_SCRIPT, 0, DarkCaveBlackthornEntrancePharmacistScript, -1
