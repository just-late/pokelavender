GoldenrodPokecomCenterOffice_MapScriptHeader:
	...
	def_object_events
	object_event  4,  4, SPRITE_SCIENTIST_F, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_RANGI, PERSONTYPE_COMMAND, jumptextfaceplayer, AdminRangiText, -1
	...
	object_event 10,  3, SPRITE_COOL_DUDE, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_BLUE, PERSONTYPE_COMMAND, jumptextfaceplayer, AdminFredrikText, -1
