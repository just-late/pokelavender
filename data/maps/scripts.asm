...
INCLUDE "maps/MarigoldGymVent.asm"
...
INCLUDE "maps/GraniteVillageTrainTrack.asm"
...
INCLUDE "maps/GemrootNicknameSpeechHouse.asm"
...
INCLUDE "maps/Route3MoonflowerGate.asm"
...
SECTION "Dream World Scripts", ROMX
