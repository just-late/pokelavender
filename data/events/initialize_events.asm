InitialEvents:
	...
	dw EVENT_MOONFLOWER_GYM_FALKNER
	...
	dw EVENT_USED_THE_RUSTY_KEY_IN_THE_RADIO_TOWER
	dw EVENT_TEACHER_GEMROOT_TOWN
	dw EVENT_LYRA_IN_HER_ROOM
	dw EVENT_LYRA_GEMROOT_TOWN
	dw EVENT_LYRA_ROUTE_34
	dw EVENT_LYRA_ROUTE_42
	dw EVENT_RIVAL_MOSSHILL_TOWN
	...
	dw EVENT_GUIDE_GENT_VISIBLE_IN_GLITTERVINE
	dw EVENT_ELMS_AIDE_IN_MOONFLOWER_POKEMON_CENTER
