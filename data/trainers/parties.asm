...
;	db -1 ; end
	...
	; party
	dbp 15, MACHOP
		db ROCK_SMASH, ICE_PUNCH, PROTECT, NO_MOVE
	db -1 ; end
	...
	; party
	dbp 17, MACHOP
		db ROCK_SMASH, THUNDERPUNCH, PROTECT, NO_MOVE
	db -1 ; end
...
WalkerGroup:
	...
	dbp 14, MAGNEMITE
		db METAL_COAT
		db THUNDER_WAVE, QUICK_ATTACK, LIGHT_SCREEN, FLASH_CANNON
	dbp 16, FARFETCH_D
		db LEEK
		db AERIAL_ACE, RAZOR_LEAF, IRON_TAIL, DOUBLE_TEAM
	dbp 18, SKARMORY
		db METAL_COAT
		db AERIAL_ACE, METAL_CLAW, DOUBLE_TEAM, BITE
	db -1 ; end
