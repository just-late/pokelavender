...
INCLUDE "gfx/pokemon/turtwig/front.dimensions"
INCLUDE "gfx/pokemon/grotle/front.dimensions"
INCLUDE "gfx/pokemon/torterra/front.dimensions"
...
INCLUDE "gfx/pokemon/goomy/front.dimensions"
