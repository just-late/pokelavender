...
; entries correspond to ANIM_OBJ_* constants
	...
	battleanimobj RELATIVE_X | X_FLIP, $b0, BATTLEANIMFRAMESET_MINIMIZE, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_GRAY, ANIM_GFX_WOOD_HAMMER ; ANIM_OBJ_MINIMIZE
	...
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_WOOD_HAMMER, BATTLEANIMFUNC_RADIAL_MOVE_OUT, PAL_BATTLE_OB_YELLOW, ANIM_GFX_SMOKE_PUFF ; ANIM_OBJ_SNOW_FALL
	...
	battleanimobj RELATIVE_X, $80, BATTLEANIMFRAMESET_WOOD_HAMMER, BATTLEANIMFUNC_RADIAL_MOVE_OUT_SLOW, PAL_BATTLE_OB_YELLOW, ANIM_GFX_SMOKE_PUFF ; ANIM_OBJ_SCALD_STEAM
	...
	battleanimobj RELATIVE_X | X_FLIP, $9a, BATTLEANIMFRAMESET_MUD_SLAP, BATTLEANIMFUNC_USER_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_GRAY, ANIM_GFX_POISON ; ANIM_OBJ_MUD_SLAP
	...
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_DROPLET_R, BATTLEANIMFUNC_RADIAL_MOVE_OUT_SLOW, PAL_BATTLE_OB_BLUE, ANIM_GFX_WOOD_HAMMER ; ANIM_OBJ_DROPLET_R
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_DROPLET_L, BATTLEANIMFUNC_RADIAL_MOVE_OUT_SLOW, PAL_BATTLE_OB_BLUE, ANIM_GFX_WOOD_HAMMER ; ANIM_OBJ_DROPLET_L
