...
TreeMonMaps:
	...
	treemon_map GEMROOT_TOWN, TREEMON_SET_CITY
	treemon_map GLITTERVINE_TOWN, TREEMON_SET_CITY
	treemon_map MOONFLOWER_CITY, TREEMON_SET_CITY
	...
	treemon_map MOONFLOWER_OUTSKIRTS, TREEMON_SET_ROUTE
	db -1
...
RockMonMaps:
	...
	treemon_map DARK_CAVE_MOONFLOWER_ENTRANCE, TREEMON_SET_ROCK
