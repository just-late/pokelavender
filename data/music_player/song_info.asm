...
SongInfo:
	...
	song_info "Glittervine Town", ORIGIN_GS, COMPOSER_JUNICHI_MASUDA, COMPOSER_NONE
	...
	song_info "Moonflower City", ORIGIN_GS, COMPOSER_GO_ICHINOSE, COMPOSER_NONE
	...
	song_info "Verdanturf Town", ORIGIN_RSE, COMPOSER_GO_ICHINOSE, COMPOSER_MMMMMM
