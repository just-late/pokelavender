...
DEF FIRST_BERRY_TREE EQU const_value
	...
	const FRUITTREE_MOONFLOWER_CITY       ; 0c
	...
	const FRUITTREE_MOONFLOWER_OUTSKIRTS  ; 28
	...
	const FRUITTREE_ROUTE_2_2		  ; 2f
	const FRUITTREE_ROUTE_2_3		  ; 30
...
; HiddenGrottoData indexes (see data/events/hidden_grottoes/grottoes.asm)
	...
	const HIDDENGROTTO_MOONFLOWER_OUTSKIRTS        ; 06
