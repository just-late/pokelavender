...
DEF FIRST_BERRY_TREE EQU const_value
	...
	const FRUITTREE_GLITTERVINE_BAY_1 ; 29
	const FRUITTREE_GLITTERVINE_BAY_2 ; 2a
	const FRUITTREE_GLITTERVINE_BAY_3 ; 2b
	const FRUITTREE_GLITTERVINE_BAY_4 ; 2c
	const FRUITTREE_GLITTERVINE_BAY_5 ; 2d
	const FRUITTREE_GLITTERVINE_BAY_6 ; 2e
...
; HiddenGrottoData indexes (see data/events/hidden_grottoes/grottoes.asm)
	...
	const HIDDENGROTTO_GLITTERVINE_BAY         ; 05
