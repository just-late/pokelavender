...
; - scripts and events (see data/maps/scripts.asm)
	...
	map_const MOONFLOWER_CITY,                            19, 20 ;  4
	map_const MOONFLOWER_MART,                             6,  4 ;  5
	map_const MOONFLOWER_GYM,                              6,  7 ;  6
	...
	map_const ROUTE_2_MOONFLOWER_GATE,					   5,  4 ; 11
