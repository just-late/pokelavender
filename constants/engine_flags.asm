...
; wJohtoBadges
	const ENGINE_PUNKBADGE
	const ENGINE_MACHINEBADGE
...
; wVisitedSpawns
	...
	const ENGINE_FLYPOINT_GEMROOT
	const ENGINE_FLYPOINT_GLITTERVINE
	const ENGINE_FLYPOINT_VIOLET
	const ENGINE_FLYPOINT_UNION_CAVE
	const ENGINE_FLYPOINT_MARIGOLD
...
; wPokemonJournals
	...
	const ENGINE_READ_FINN_JOURNAL
