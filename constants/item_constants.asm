...
DEF FIRST_MEGA_STONE EQU const_value
	const VENUSAURITE
	const CHARIZARDITE_X
	const CHARIZARDITE_Y
	const BLASTOISINITE
	const ALAKAZITE
	const GENGARITE
	const BEEDRILLITE
	...
	const HOUNDOOMINITE
	const TYRANITARITE
DEF NUM_MEGA_STONES EQU const_value - FIRST_MEGA_STONE
...
; Alphabetical order (see data/items/name_order.asm)
	...
	const NAM_AERODACTYLITE
	const NAM_AIR_BALLOON
	const NAM_ALAKAZITE
	const NAM_AMPHAROSITE
...
endc
	...
	const NAM_CARBOS
	const NAM_CHARCOAL
	const NAM_CHARIZARDITE_X
	const NAM_CHARIZARDITE_Y
	...
	const NAM_HERACRONITE
	const NAM_HONDEW_BERRY
	const NAM_HOUNDOOMINITE
...
endc
	...
	const NAM_TYRANITARITE
	const NAM_ULTRA_BALL
	const NAM_UP_GRADE
	const NAM_VENUSAURITE
