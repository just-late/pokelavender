...
; Atuva Gym Leader TM gifts
	const EVENT_GOT_TM08_VENOSHOCK
...
; HMs
	...
	const EVENT_GOT_HM07_ROCK_SMASH
...
; Johto story events
	...
	const EVENT_DID_TYPHLOSIONS_QUEST
	const EVENT_BOULDER_IN_GANG_APARTMENT
	const BLAZE_IN_APARTMENT_1F
	const BLAZE_IN_APARTMENT_2F
	...
	const EVENT_GOT_VEGETABLES_FROM_PHARMACY
	const EVENT_GOT_SS_TICKET_FROM_ELM
	const EVENT_USED_THE_RUSTY_KEY_IN_THE_RADIO_TOWER
	...
	const EVENT_GOT_GOOMY_EGG_FROM_ELMS_AIDE
	...
	const EVENT_RECEIVED_RUSTY_KEY
	const EVENT_LANCE_HEALED_YOU_IN_TEAM_ROCKET_BASE
	const EVENT_GOT_MYSTIC_WATER_IN_GLITTERVINE
	...
	const EVENT_GOOMY_HATCHED
	const EVENT_SHOWED_GOOMY_TO_ELM
	...
	const EVENT_TOLD_ELM_ABOUT_GOOMY_OVER_THE_PHONE
...
; Johto hidden items
	...
	const EVENT_MARIGOLD_CAVE_1F_HIDDEN_GREAT_BALL
	const EVENT_MARIGOLD_CAVE_1F_HIDDEN_BIG_PEARL
	const EVENT_MARIGOLD_CAVE_1F_HIDDEN_PARALYZEHEAL
	...
	const EVENT_DARK_CAVE_MOONFLOWER_ENTRANCE_HIDDEN_ELIXIR
	...
	const EVENT_GEMROOT_TOWN_HIDDEN_POTION
	const EVENT_MOSSHILL_TOWN_HIDDEN_NUGGET
	const EVENT_MOONFLOWER_CITY_HIDDEN_POKE_BALL
	const EVENT_MOONFLOWER_CITY_HIDDEN_HYPER_POTION
...
; Decorations
	...
	const EVENT_DECO_TURTWIG_DOLL
	const EVENT_DECO_CYNDAQUIL_DOLL
	const EVENT_DECO_MUDKIP_DOLL
...
; More Johto story events
	...
	const EVENT_SHOWED_GOOMY_TO_BILLS_GRANDPA
...
; Johto itemballs
	const EVENT_FIRE_POKEBALL_IN_COMMUNITYCENTER
	const EVENT_WATER_POKEBALL_IN_COMMUNITYCENTER
	const EVENT_GRASS_POKEBALL_IN_COMMUNITYCENTER
	const EVENT_MOONFLOWER_CITY_PP_UP
	const EVENT_MOONFLOWER_CITY_RARE_CANDY
	const EVENT_MARIGOLD_GYM_VENT_METAL_COAT
	...
	const EVENT_MARIGOLD_CAVE_1F_GREAT_BALL
	const EVENT_MARIGOLD_CAVE_1F_X_ATTACK
	const EVENT_MARIGOLD_CAVE_1F_POTION
	const EVENT_MARIGOLD_CAVE_1F_AWAKENING
	...
	const EVENT_DARK_CAVE_MOONFLOWER_ENTRANCE_POTION
	const EVENT_DARK_CAVE_MOONFLOWER_ENTRANCE_DUSK_STONE
	const EVENT_DARK_CAVE_MOONFLOWER_ENTRANCE_HYPER_POTION
...
; Johto people
	const EVENT_TEACHER_GEMROOT_TOWN
	const EVENT_LYRA_GEMROOT_TOWN
	...
	const EVENT_RIVAL_GEMROOT_TOWN
	const EVENT_RIVAL_MOSSHILL_TOWN
	...
	const EVENT_MOONFLOWER_CITY_EARL
	const EVENT_EARLS_ACADEMY_EARL
	const EVENT_MOONFLOWER_GYM_FALKNER
	...
	const EVENT_GUIDE_GENT_VISIBLE_IN_GLITTERVINE
	const EVENT_ELMS_AIDE_IN_MOONFLOWER_POKEMON_CENTER
	...
	const EVENT_MOONFLOWER_FAIRY_BOOK
...
; New to Crystal
	...
	const EVENT_DARK_CAVE_MOONFLOWER_ENTRANCE_DIRE_HIT
...
; Cut trees
	...
	const EVENT_MOONFLOWER_CITY_CUT_TREE
...
; pokelavender story events
	...
	const EVENT_GOT_SOUVENEIR_FROM_ATUVA_TRAVELER
	const EVENT_GOT_A_POKEMON_FROM_ELDER
	const EVENT_GOT_CYNDAQUIL_FROM_ELDER
	const EVENT_GOT_MUDKIP_FROM_ELDER
	const EVENT_GOT_TURTWIG_FROM_ELDER
	const EVENT_DOING_BLAZE_QUEST
	const EVENT_DID_BLAZE_QUEST
	const EVENT_GOT_BOAT_PASS_FROM_BLAZE
	const EVENT_MOONFLOWER_CITY_INDIGO_BLOCKERS
	const EVENT_BEAT_RIVAL_IN_MOONFLOWER
	const EVENT_TALKED_TO_DREAMWORLD_PLAYER
	const EVENT_MARIGOLD_PORT_PHOTO
	const EVENT_BEAT_INDIGO_MARIGOLD_CAVE
	const EVENT_RIVAL_IN_GRANITE_VILLAGE
	const EVENT_GRANITE_VILLAGE_GREET_SCENE
	const EVENT_INDIGO_BLOCK_GRANITE_VILLAGE
	const EVENT_INDIGO_IN_GRANITE_INN
	const EVENT_SAVED_GRANITE_VILLAGE
	const EVENT_OREDALE_CITY_RUSTY_KEY
	const EVENT_GOT_OREDALE_APRICORN_BOX
	const EVENT_SWINUB_QUEST_STARTED
	const EVENT_SWINUB_1_FOUND
	const EVENT_SWINUB_2_FOUND
	const EVENT_SWINUB_3_FOUND
	const EVENT_SWINUB_4_FOUND
	const EVENT_ALL_SWINUBS_FOUND
	const EVENT_SWINUB_QUEST_FINISHED
; Anabel Events
	const EVENT_ANABEL_IN_COMMUNITYCENTER
	const EVENT_ANABEL_AT_HOME
	const EVENT_ANABEL_GEMROOT_SCENE
	const EVENT_ANABEL_BEDROOM_SCENE
	const EVENT_ANABEL_HOUSE_SCENE
	const EVENT_ANABEL_MOSSHILL_TOWN
; Disorganized Events
	const EVENT_MOM_SHOWED_HOW_TO_USE_PC
	const EVENT_GOT_BIKE
	const EVENT_POKEGEAR_CAMPAIGN_IN_MOONFLOWER
	const EVENT_GOT_POKEGEAR_QUESTION1
	const EVENT_GOT_POKEGEAR_QUESTION2
	const EVENT_SAW_MOM_AFTER_STARTER
	const EVENT_ELECTRODE_GONE
; Tide Events
